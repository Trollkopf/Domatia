    ...
    public function boot()
    {
        View::composer('*', function ($view) {
            ...
            $view->with('siteSettings', [
                ...
                'contact_intro' => $setting('contact_intro', 'Estamos aquí para ayudarte a encontrar la propiedad adecuada y resolver cualquier duda.'),
                'about_heading' => $setting('about_heading', 'Nuestra filosofía'),
                ...
                'home_hero_subtitle' => $setting('home_hero_subtitle', 'En los destinos más deseados'),
                'home_search_button_text' => $setting('home_search_button_text', 'Buscar'),
                'home_value_1' => $setting('home_value_1', 'Selección curada de propiedades'),
                'home_value_2' => $setting('home_value_2', 'Acompañamiento cercano de principio a fin'),
                ...
                'home_featured_subtitle' => $setting('home_featured_subtitle', 'Una selección cuidada para empezar con lo mejor del catálogo.'),
                'home_cta_heading' => $setting('home_cta_heading', 'Te acompañamos en cada paso de la compra'),
                'home_cta_body' => $setting('home_cta_body', 'Desde la primera visita hasta la firma, trabajamos con un enfoque claro, cercano y orientado a cerrar bien cada operación.'),
                ...
                'about_header_title' => $setting('about_header_title', 'Conócenos'),
                'about_header_image' => $setting('about_header_image', '/images/our-company.jpg'),
                'contact_header_title' => $setting('contact_header_title', 'Contáctanos'),
