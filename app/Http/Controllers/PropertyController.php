...
class PropertyController extends Controller
{
    ...
    private function propertyRules(): array
    {
        return [
            ...
            'title_nl' => 'nullable|string|max:255', 'title_pl' => 'nullable|string|max:255', 'title_sv' => 'nullable|string|max:255', 'title_da' => 'nullable|string|max:255',
            'location' => 'nullable|string|max:255',
            'location_en' => 'nullable|string|max:255',
            'location_fr' => 'nullable|string|max:255',
            'location_de' => 'nullable|string|max:255',
            'location_ru' => 'nullable|string|max:255',
            'location_nl' => 'nullable|string|max:255', 'location_pl' => 'nullable|string|max:255', 'location_sv' => 'nullable|string|max:255', 'location_da' => 'nullable|string|max:255',
            ...
            'description_nl' => 'nullable|string', 'description_pl' => 'nullable|string', 'description_sv' => 'nullable|string', 'description_da' => 'nullable|string',
            ...
            'quick_summary_1_nl' => 'nullable|string|max:255', 'quick_summary_1_pl' => 'nullable|string|max:255', 'quick_summary_1_sv' => 'nullable|string|max:255', 'quick_summary_1_da' => 'nullable|string|max:255',
            ...
            'quick_summary_2_nl' => 'nullable|string|max:255', 'quick_summary_2_pl' => 'nullable|string|max:255', 'quick_summary_2_sv' => 'nullable|string|max:255', 'quick_summary_2_da' => 'nullable|string|max:255',
            ...
            'quick_summary_3_nl' => 'nullable|string|max:255', 'quick_summary_3_pl' => 'nullable|string|max:255', 'quick_summary_3_sv' => 'nullable|string|max:255', 'quick_summary_3_da' => 'nullable|string|max:255',
    ...
    private function buildPropertyPayload(Request $request, array $validated, array $publicationState): array
    {
        ...
        return [
            ...
            'title_nl' => $validated['title_nl'] ?? null, 'title_pl' => $validated['title_pl'] ?? null, 'title_sv' => $validated['title_sv'] ?? null, 'title_da' => $validated['title_da'] ?? null,
            ...
            'location_nl' => $validated['location_nl'] ?? null, 'location_pl' => $validated['location_pl'] ?? null, 'location_sv' => $validated['location_sv'] ?? null, 'location_da' => $validated['location_da'] ?? null,
            ...
            'description_nl' => $validated['description_nl'] ?? null, 'description_pl' => $validated['description_pl'] ?? null, 'description_sv' => $validated['description_sv'] ?? null, 'description_da' => $validated['description_da'] ?? null,
            ...
            'quick_summary_1_nl' => $validated['quick_summary_1_nl'] ?? null, 'quick_summary_1_pl' => $validated['quick_summary_1_pl'] ?? null, 'quick_summary_1_sv' => $validated['quick_summary_1_sv'] ?? null, 'quick_summary_1_da' => $validated['quick_summary_1_da'] ?? null,
            ...
            'quick_summary_2_nl' => $validated['quick_summary_2_nl'] ?? null, 'quick_summary_2_pl' => $validated['quick_summary_2_pl'] ?? null, 'quick_summary_2_sv' => $validated['quick_summary_2_sv'] ?? null, 'quick_summary_2_da' => $validated['quick_summary_2_da'] ?? null,
            ...
            'quick_summary_3_nl' => $validated['quick_summary_3_nl'] ?? null, 'quick_summary_3_pl' => $validated['quick_summary_3_pl'] ?? null, 'quick_summary_3_sv' => $validated['quick_summary_3_sv'] ?? null, 'quick_summary_3_da' => $validated['quick_summary_3_da'] ?? null,
        ];
    }
